  ...
  <v-expansion-panels class="my-5">
    <v-expansion-panel>
      ...
      <v-expansion-panel-text>
        <p class="my-3">
          Make sure the projector and subject is ready before taking the photo!
          You can use the light-meter to ensure you get the right light levels.
          Also see the device options for brightness and amplification controls.
        </p>
        <p class="my-3">
          Not all single-pixel combinations are available.
          Try these: 1x1+4x4 2x2+16x16 2x2+32x32 2x2+64x64
            4x4+128x128 4x4+32x32 4x4+64x64 6x6+64x64 8x8+64x64 8x8+128x128x
        </p>
        <p class="my-3">
          Fourier images are 1/2 the size of the mask.
        </p>
      </v-expansion-panel-text>
    </v-expansion-panel>
  </v-expansion-panels>
